...
/**
 * Strings for component 'mod_bookking', language 'en'
 *
 */

$string['pluginname'] = 'BookKing';
$string['pluginadministration'] = 'BookKing administration';
$string['modulename'] = 'BookKing';
$string['modulename_help'] = 'The BookKing activity allows lecturers to organise meetings, consultations, presentations, etc. by creating slots during a predetermined time frame, which can then be booked by students.';
$string['modulename_link'] = 'mod/bookking/view';
$string['modulenameplural'] = 'BookKings';

/* ***** Capabilities ****** */
$string['bookking:addinstance'] = 'Add a new bookking';
$string['bookking:appoint'] = 'Book slots';
$string['bookking:attend'] = 'Attend students';
$string['bookking:canscheduletootherteachers'] = 'Schedule appointments for other staff members';
$string['bookking:canseeotherteachersbooking'] = 'See and browse other teachers booking';
$string['bookking:disengage'] = 'This capability is deprecated and does nothing';
$string['bookking:manage'] = 'Manage your slots and appointments';
$string['bookking:manageallappointments'] = 'Manage all bookking data';
$string['bookking:viewslots'] = 'See slots that are open for booking (in student screen)';
$string['bookking:viewfullslots'] = 'See slots even if they are fully booked (in student screen)';
$string['bookking:seeotherstudentsbooking'] = 'See other students booked on the slot';
$string['bookking:seeotherstudentsresults'] = 'See other slot student\'s results';
$string['bookking:seeoverviewoutsideactivity'] = 'Use the overview screen to see slots outside the current bookking activity.';

/* ***** Events ***** */
$string['event_bookingformviewed'] = 'BookKing booking form viewed';
$string['event_bookingadded'] = 'BookKing booking added';
$string['event_bookingremoved'] = 'BookKing booking removed';
$string['event_appointmentlistviewed'] = 'BookKing appointment list viewed';
$string['event_slotadded'] = 'BookKing slot added';
$string['event_slotdeleted'] = 'BookKing slot deleted';
...
/* ***** Search areas ***** */
$string['search:activity'] = 'BookKing - activity information';

/* ***** Privacy API strings **** */

$string['privacy:metadata:bookking_slots'] = 'Represents one slot in a bookking';

$string['privacy:metadata:bookking_slots:teacherid'] = 'Teacher associated with the slot';
$string['privacy:metadata:bookking_slots:starttime'] = 'Start time of the slot';
$string['privacy:metadata:bookking_slots:duration'] = 'Duration of the slot in minutes';
$string['privacy:metadata:bookking_slots:appointmentlocation'] = 'Appointment location';
$string['privacy:metadata:bookking_slots:notes'] = 'Notes about the slot';
$string['privacy:metadata:bookking_slots:notesformat'] = "Format of the notes";
$string['privacy:metadata:bookking_slots:exclusivity'] = "Maximum number of students on the slot";

$string['privacy:metadata:bookking_appointment'] = 'Represents a student appointment in a bookking';

$string['privacy:metadata:bookking_appointment:studentid'] = "Student who booked the appointment";
$string['privacy:metadata:bookking_appointment:attended'] = "Whether the appointment was attended";
$string['privacy:metadata:bookking_appointment:grade'] = "Grade for the appointment";
$string['privacy:metadata:bookking_appointment:appointmentnote'] = "Note by teacher (visible to student)";
$string['privacy:metadata:bookking_appointment:appointmentnoteformat'] = "Format of teacher note";
$string['privacy:metadata:bookking_appointment:teachernote'] = "Note by teacher (private)";
$string['privacy:metadata:bookking_appointment:teachernoteformat'] = "Format of private teacher note";
$string['privacy:metadata:bookking_appointment:studentnote'] = "Note by student";
$string['privacy:metadata:bookking_appointment:studentnoteformat'] = "Format of student note";
...
$string['canbooksingleappointment'] = 'You can book one appointment in this bookking.';
$string['canbook1appointment'] = 'You can book one more appointment in this bookking.';
$string['canbooknappointments'] = 'You can book {$a} more appointments in this bookking.';
$string['canbooknofurtherappointments'] = 'You cannot book further appointments in this bookking.';
$string['canbookunlimitedappointments'] = 'You can book any number of appointments in this bookking.';
$string['chooseexisting'] = 'Choose existing';
$string['choosingslotstart'] = 'Choosing the start time';
$string['comments'] = 'Comments';
$string['conflictlocal'] = '{$a->datetime} ({$a->duration} minutes) in this bookking';
$string['conflictremote'] = '{$a->datetime} ({$a->duration} minutes) in course {$a->courseshortname}, bookking {$a->bookkingname}';
...
$string['confirmdelete-all'] = 'This will delete <b>all</b> slots in this bookking. Deletion cannot be undone. Continue anyway?';
$string['confirmdelete-mine'] = 'This will delete all your slots in this bookking. Deletion cannot be undone. Continue anyway?';
$string['confirmdelete-myunused'] = 'This will delete all your unused slots in this bookking. Deletion cannot be undone. Continue anyway?';
...
$string['confirmdelete-unused'] = 'This will delete all unused slots in this bookking. Deletion cannot be undone. Continue anyway?';
...
$string['explaingeneralconfig'] = 'These options can only be setup at site level and will apply to all bookkings of this Moodle installation.';
...
$string['gradingstrategy_help'] = 'In a bookking where students can have several appointments, select how grades are aggregated.
...
(Apart from the global option, the setting "Booking in groups" must be enabled in the respective bookking instance.)';
$string['groupsession'] = 'Group session';
$string['groupsize'] = 'Group size';
$string['guardtime'] = 'Cut-off time';
$string['guestscantdoanything'] = 'Guests can\'t do anything here.';
$string['htmlformat'] = 'HTML';
$string['howtoaddstudents'] = 'For adding students to a global scoped bookking, use the role setting for the module.<br/>You may also use module role definitions to define the attenders of your students.';
...
$string['ignoreconflicts_link'] = 'mod/bookking/conflict';
...
$string['maxstudentlistsize_desc'] = 'The maximum length of the list of students who need to make an appointment, as shown in the teacher view of the bookking. If there are more students than this, no list will be displayed.';
...
$string['nobookkings'] = 'There are no bookkings';
...
$string['resetslots'] = 'Delete bookking slots';
...
$string['showemailplain_desc'] = 'In the teacher\'s view of the bookking, show the e-mail addresses of students needing an appointment in plain text, in addition to mailto: links.';
...
$string['thisbookking'] = 'this bookking';
...
$string['uploadmaxfilesglobal_desc'] = 'The maximum number of files that a student can upload in a booking form. This can be reduced further at the level of individual bookkings.';
...
$string['usebookingform_link'] = 'mod/bookking/bookingform';
...
';
$string['forcewhenoverlap_link'] = 'mod/bookking/conflict';
...
$string['guardtime_help'] = 'A cut-off time prevents students from changing their booking shortly before the appointment.
<p>If the cut-off time is enabled and set to, for example, 2 hours, then students will be unable to book a slot that starts in less than 2 hours time from now,
...
using the bookking titled "{$a->module}" on the website: {$a->site}.';
...
<p>using the bookking titled "<em><a href="{$a->bookking_url}">{$a->module}</a></em>" on the website: <a href="{$a->site_url}">{$a->site}</a>.</p>';
...
in the bookking titled "{$a->module}" on the website : {$a->site}
...
<p>in the bookking titled "<em><a href="{$a->bookking_url}">{$a->module}</a></em>" on the website : <strong><a href="{$a->site_url}">{$a->site}</a></strong></p>
...
<p>in the bookking "<em><a href="{$a->bookking_url}">{$a->module}</a></em>" on the website: <strong><a href="{$a->site_url}">{$a->site}</a></strong></p>
...
$string['email_invite_html'] = '<p>Please choose a time slot for an appointment at:</p> <p>{$a->bookking_url}</p>';

$string['email_invitereminder_subject'] = 'Reminder: {$a->module}';
$string['email_invitereminder_html'] = '<p>This is just a reminder that you have not yet set up your appointment. Please choose a time slot as soon as possible at:</p><p>{$a->bookking_url}</p>';
