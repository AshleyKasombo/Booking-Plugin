...
$string['modulename_help'] = 'BookKing allows students to schedule appointments with lecturers, depending on stipulated timeslots.';
$string['modulename_link'] = 'mod/bookking/view';
$string['modulenameplural'] = 'BookKings';

/* ***** Capabilities ****** */
$string['bookking:addinstance'] = 'Add a new bookking';
$string['bookking:appoint'] = 'Appoint';
...
$string['bookking:seeotherstudentsbooking'] = 'See other student booking on the slot';
$string['bookking:seeotherstudentsresults'] = 'See other slot student\'s result';
...
$string['thisscheduler'] = 'this bookking';
...
<p>using the bookking titled "<em>{$a->module}</em>" on the website: <a href="{$a->site_url}">{$a->site}</a>.</p>';
...
<p>in the bookking titled "<em>{$a->module}</em>" on the website : <strong><a href="{$a->site_url}">{$a->site}</a></strong></p>
...
<p>in the bookking "<em>{$a->module}</em>" on the website: <strong><a href="{$a->site_url}">{$a->site}</a></strong></p>
