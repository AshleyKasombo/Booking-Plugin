...
//General library for the bookking module.
...
function bookking_print_user($user, $course, $messageselect=false, $return=false) {
    ...
    $extrafields = bookking_get_user_fields($user, $context);
...
class bookking_file_info extends file_info {
    ...
    protected $filearea;
    /** @var bookking_instance The bookking that this file area refers to */
    protected $bookking;
    ...
    public function __construct($browser, $course, $cm, $context, $areas, $filearea) {
        ...
        $this->bookking = bookking_instance::load_by_coursemodule_id($cm->id);
    }
    ...
    private function get_filtered_children($extensions = '*', $countonly = false, $returnemptyfolders = false) {
        ...
        foreach ($rs as $record) {
            if ($child = $this->browser->get_file_info($this->context, 'mod_bookking', $this->filearea, $record->id)) {
